  ...
  <Popover v-slot="{ open, setOpen }">
    <PopoverTrigger as-child>
      <Button
        ...
        :class="cn(
          `
            extend-touch-target h-8 touch-manipulation items-center justify-start gap-2.5 !p-0
    ...
    <PopoverContent
      class="
        no-scrollbar h-(--reka-popper-available-height) w-(--reka-popper-available-width)
        overflow-y-auto rounded-none border-none bg-background/90 p-0 shadow-none backdrop-blur
        duration-100
      "
      align="start"
      side="bottom"
